...
#define STRING_CONFIG_H_AUTHOR "(Obsessively Geek 3D, Ender 3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Empanada"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 0, 1.02 }
